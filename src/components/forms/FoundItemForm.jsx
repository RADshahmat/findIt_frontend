...
import { Upload, X, MapPin, ChevronDown, CheckCircle } from "lucide-react"
...
const FoundItemForm = ({
  initialData,
  onSubmit,
  submitButtonText = "Report Found Item",
  submitButtonClass = "bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white",
  isLoading = false,
}) => {
    ...
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white ${
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Item Condition</label>
            <select
              name="condition"
      ...
      <motion.div variants={sectionVariants} className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div ref={dropdownRef} className="relative">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-3 py-2 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 bg-white dark:bg-gray-800 text-gray-900 dark:text-white ${
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Date Found *</label>
            <input
              type="date"
              name="date"
              value={formData.date}
      ...
      {/* Images */}
      <motion.div variants={sectionVariants} className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
        <h3 className="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Images (Recommended)</h3>
      ...
      >
        <h3 className="text-lg font-semibold mb-4 text-blue-800 dark:text-blue-200">Handover Preference</h3>
        <div className="space-y-3">
          {[
            { value: "meetup", label: "Meet in person at a public place" },
            { value: "delivery", label: "Delivery (owner pays delivery cost)" },
            { value: "pickup", label: "Owner can pick up from my location" },
          ].map((option) => (
            <motion.label key={option.value} whileHover={{ scale: 1.02 }} className="flex items-center cursor-pointer">
              <input
                type="radio"
      ...
      {submitSuccess && (
        <motion.div
          ...
          transition={{ duration: 0.3 }}
          className="fixed top-6 right-6 z-50 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-700 dark:text-green-300 px-6 py-4 rounded-lg shadow-lg flex items-center"
        >
          <CheckCircle className="h-5 w-5 mr-3 text-green-600 dark:text-green-300" />
          <span className="font-medium">Found item report created successfully!</span>
        </motion.div>
      )}
