...
const { archivedReports, loading } = useSelector(state => state.reports);
  ...
  const lostReports = archivedReports.filter((r) => r.status === "lost").length;
  const foundReports = archivedReports.filter((r) => r.status === "found").length;
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-sm border border-gray-100 dark:border-gray-700">
        <div className="flex items-center justify-center">
          ...
          <span className="ml-3 text-gray-600 dark:text-gray-300">
            Loading your Archived reports...
          </span>
        </div>
      </div>
    );
  }
  console.log("Rendering MyReports with archivedReports:", archivedReports);
  return (
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex space-x-2">
                          <motion.button
                            ...
                            className="flex-1 flex items-center justify-center px-4 py-2 text-blue-600 hover:bg-blue-50 dark:text-blue-400 dark:hover:bg-blue-500/10 rounded-lg transition-colors border border-blue-200 dark:border-blue-800"
                          >
